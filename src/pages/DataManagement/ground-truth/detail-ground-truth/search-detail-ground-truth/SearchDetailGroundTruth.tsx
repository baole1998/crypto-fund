...
import './SearchDetailGroundTruth.scss';
...
interface PropSearchDetailGroundTruth {
  openSearch: boolean;
...
const SearchDetailGroundTruth: React.FC<PropSearchDetailGroundTruth> = (
  props
) => {
  const {
    openSearch,
...
export default SearchDetailGroundTruth;
