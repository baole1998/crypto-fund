...
import './SearchDetailGeneralDataManagement.scss';
...
interface PropSearchDetailGeneralDataManagement {
  openSearch: boolean;
...
const SearchDetailGeneralDataManagement: React.FC<PropSearchDetailGeneralDataManagement> = (
  props
) => {
  const {
    openSearch,
      ...
      <div className="content-search">
        {/* <div className="item-search">
          ...
          <div className="d-flex content-item-search mb-3">
            <div
              onClick={() => onChangeSearch('status', 'khởi tạo')}
              className={`select-item ${
                onCheckStatus('khởi tạo') === true ? 'selected' : ''
              }`}
            >
              <img
            ...
            <div
              onClick={() => onChangeSearch('status', 'thành công')}
              className={`select-item ${
                onCheckStatus('thành công') === true ? 'selected' : ''
              }`}
            >
              <img
                src={'/static/images/status/checked.svg'}
          ...
          <div className="d-flex content-item-search">
            <div
              onClick={() => onChangeSearch('status', 'đang xử lý')}
              className={`select-item ${
                onCheckStatus('đang xử lý') === true ? 'selected' : ''
              }`}
            >
              <img
                src={'/static/images/status/checked.svg'}
            ...
            <div
              onClick={() => onChangeSearch('status', 'không thành công')}
              className={`select-item ${
                onCheckStatus('không thành công') === true ? 'selected' : ''
              }`}
            >
              <img
                src={'/static/images/status/checked.svg'}
...
export default SearchDetailGeneralDataManagement;
